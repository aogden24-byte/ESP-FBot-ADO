...
class Fbot : public esphome::ble_client::BLEClientNode, public Component {
 public:
  ...
  // Public Interface for Switches and Numbers
  ...
  // Binary Sensor Setters (Fixed missing members)
  ...
  // Switch/Number Setters (Fixed missing members)
...
// FIXED: Correct Action Bridge signature for TemplatableValue
